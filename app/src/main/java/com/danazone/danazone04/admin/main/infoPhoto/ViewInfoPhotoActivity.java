package com.danazone.danazone04.admin.main.infoPhoto;
...
@EActivity(R.layout.activity_view_info_photo)
public class ViewInfoPhotoActivity extends BaseActivity {
    @ViewById
    TextView mTvName;
    @ViewById
    TextView mTvPhone;
    ...
    protected void afterView() {
        if (mUsers != null) {
            ...
            mTvBusiness.setText(mUsers.getBussiness());
    ...
    void onClich(View v) {
        switch (v.getId()) {
            ...
            case R.id.mRlEmail:
                ...
                intent.putExtra(Intent.EXTRA_SUBJECT, "DaNa Photo");
