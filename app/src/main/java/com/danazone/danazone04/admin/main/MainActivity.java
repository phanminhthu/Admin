package com.danazone.danazone04.admin.main;
...
import com.danazone.danazone04.admin.main.photo.DaNaPhotoActivity;
import com.danazone.danazone04.admin.main.photo.DaNaPhotoActivity_;
...
public class MainActivity extends BaseActivity {
    ...
    @Click({R.id.mImgAdd, R.id.mImgRemove, R.id.mTvPhoto})
    void onClick(View v) {
        switch (v.getId()) {
            case R.id.mImgAdd:
            ...
            case R.id.mTvPhoto:
                DaNaPhotoActivity_.intent(this).start();
                break;
        }
